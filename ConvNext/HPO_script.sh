...
python train.py --use_gpu --batch_size 32 --epochs 10 --option convNext --from_pretrain

python train.py --use_gpu --batch_size 64 --epochs 10 --option convNext --from_pretrain

python train.py --use_gpu --batch_size 128 --epochs 10 --option convNext --from_pretrain
